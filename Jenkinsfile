  ...
  stages {
    ...
    stage('RunPlaybook') {
      steps {
        ...
        sh "ansible-playbook -i inventory/aws_ec2.yaml  playbooks/tomcat-setup.yaml -u ec2-user --private-key=$AWS_EC2_PRIVATE_KEY --limit tomcatserver  --ssh-common-args='-o StrictHostKeyChecking=no'"
      }
    }
